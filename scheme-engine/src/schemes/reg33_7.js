...
export const meta = {
  id: 'REG_33_7',
  title: 'Regulation 33(7) — Redevelopment of cessed buildings, Island City, by co-op housing societies',
  regulation: '33(7)',
...
export function evaluate(_parcelFacts = {}, _buildingFacts = {}) {
  return {
    ...
    reasons: [
      {
        text:
          'Regulation 33(7) eligibility conditions (which buildings qualify as "cessed", ownership/society ' +
          'requirements, consent thresholds) and its FSI formula have not been pulled from primary clause ' +
          'text. Only the subject is confirmed so far.',
      },
    ],
    sources: [
      {
